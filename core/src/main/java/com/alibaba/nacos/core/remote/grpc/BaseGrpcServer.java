...
public abstract class BaseGrpcServer extends BaseRpcServer {
    ...
    public void startServer() throws Exception {
        System.out.println("[PROBE][BaseGrpcServer.startServer] class=" + this.getClass().getSimpleName()
                + ", port=" + getServicePort()
                + ", maxInboundMsgSize=" + getInboundMessageSize() + " bytes");
        ...
        server.start();
        System.out.println("[PROBE][BaseGrpcServer.startServer] gRPC server started successfully, class="
                + this.getClass().getSimpleName() + ", port=" + getServicePort());
    }
    ...
    private void addServices(MutableHandlerRegistry handlerRegistry, ServerInterceptor... serverInterceptor) {
        ...
        System.out.println("[PROBE][BaseGrpcServer.addServices] 注册了2个服务: "
                + REQUEST_SERVICE_NAME + "(Unary) 和 " + REQUEST_BI_STREAM_SERVICE_NAME + "(BiStream)");
