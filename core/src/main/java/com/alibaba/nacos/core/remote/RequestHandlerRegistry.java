...
public class RequestHandlerRegistry implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        for (RequestHandler requestHandler : values) {
            ...
            System.out.println("[PROBE][RequestHandlerRegistry] 注册Handler: requestType=" + tClass.getSimpleName()
                    + " -> handler=" + requestHandler.getClass().getSimpleName());
        }
        System.out.println("[PROBE][RequestHandlerRegistry] 全部Handler注册完毕, 共" + registryHandlers.size() + "个");
    }
}
