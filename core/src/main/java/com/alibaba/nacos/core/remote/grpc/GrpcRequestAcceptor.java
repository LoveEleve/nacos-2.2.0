...
public class GrpcRequestAcceptor extends RequestGrpc.RequestImplBase {
    ...
    public void request(Payload grpcRequest, StreamObserver<Payload> responseObserver) {
        ...
        System.out.println("[PROBE][GrpcRequestAcceptor.request] Unary请求到达"
                + ", type=" + type
                + ", connectionId=" + CONTEXT_KEY_CONN_ID.get()
                + ", handlerFound=" + (requestHandler != null)
                + ", handler=" + (requestHandler != null ? requestHandler.getClass().getSimpleName() : "null"));
        //no handler found.
