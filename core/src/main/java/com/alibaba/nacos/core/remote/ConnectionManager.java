...
public class ConnectionManager {
    ...
    public synchronized boolean register(String connectionId, Connection connection) {
        ...
        if (connection.isConnected()) {
            ...
            System.out.println("[PROBE][ConnectionManager.register] 连接注册成功"
                    + ", connectionId=" + connectionId
                    + ", clientIp=" + clientIp
                    + ", isSdkSource=" + connection.getMetaInfo().isSdkSource()
                    + ", totalConnections=" + connections.size()
                    + ", connectionsFromThisIp=" + connectionForClientIp.get(clientIp).get());
    ...
    public synchronized void unregister(String connectionId) {
        ...
        if (remove != null) {
            ...
            System.out.println("[PROBE][ConnectionManager.unregister] 连接注销"
                    + ", connectionId=" + connectionId
                    + ", clientIp=" + clientIp
