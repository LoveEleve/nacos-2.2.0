        ...
        StreamObserver<Payload> streamObserver = new StreamObserver<Payload>() {
            ...
            public void onNext(Payload payload) {
                ...
                if (parseObj instanceof ConnectionSetupRequest) {
                    ...
                    System.out.println("[PROBE][GrpcBiStreamRequestAcceptor.onNext] ConnectionSetupRequest收到"
                            + ", connectionId=" + connectionId
                            + ", clientIp=" + payload.getMetadata().getClientIp()
                            + ", remoteIp=" + remoteIp + ":" + remotePort
                            + ", localPort=" + localPort
                            + ", clientVersion=" + setUpRequest.getClientVersion()
                            + ", appName=" + appName
                            + ", tenant=" + setUpRequest.getTenant());
                    ...
                    System.out.println("[PROBE][GrpcBiStreamRequestAcceptor.onNext] 尝试注册连接"
                            + ", connectionId=" + connectionId
                            + ", rejectSdkOnStarting=" + rejectSdkOnStarting);
