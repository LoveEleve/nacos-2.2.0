...
public class StandaloneMemberLookup extends AbstractMemberLookup {
    ...
    public void doStart() {
        ...
        System.out.println("[PROBE][StandaloneMemberLookup.doStart] 单机模式成员列表初始化, localAddress=" + url);
        afterLookup(MemberUtil.readServerConf(Collections.singletonList(url)));
        System.out.println("[PROBE][StandaloneMemberLookup.doStart] 成员列表已设置, 共1个节点: " + url);
    }
